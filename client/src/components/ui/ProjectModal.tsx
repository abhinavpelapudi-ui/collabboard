  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-surface-raised border border-surface-border rounded-2xl w-full max-w-lg p-6 shadow-2xl" onClick={e => e.stopPropagation()}>
        <h2 className="text-lg font-semibold text-slate-900 mb-4">{isEdit ? 'Edit Project' : 'New Project'}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-surface-overlay text-slate-900 text-sm px-3 py-2.5 rounded-lg border border-surface-border outline-none focus:border-indigo-500"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-surface-overlay text-slate-900 text-sm px-3 py-2.5 rounded-lg border border-surface-border outline-none focus:border-indigo-500 resize-none"
            />
          </div>
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <select
                ...
                className="w-full bg-surface-overlay text-slate-900 text-sm px-3 py-2.5 rounded-lg border border-surface-border outline-none"
              >
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            <button type="button" onClick={onClose} className="text-slate-500 hover:text-slate-900 text-sm px-4 py-2 rounded-lg">
              Cancel
            </button>
            <button
              type="submit"

...
export default function ObjectDetailPanel({ boardId, objectId, socketRef, onClose }: Props) {
  ...
  const statusColors: Record<string, string> = {
    todo: 'text-gray-400', in_progress: 'text-blue-400', review: 'text-purple-400', done: 'text-green-400',
  }

  return (
    <div className="absolute right-0 top-12 bottom-0 w-80 bg-gray-900 border-l border-gray-700 z-20 flex flex-col overflow-hidden">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-800 text-gray-200 text-xs rounded-md px-2 py-1.5 border border-gray-600 outline-none"
          >
        ...
        <div>
          ...
          <div className="flex gap-1">
            <input
              className="flex-1 bg-gray-800 text-white text-xs rounded-md px-2 py-1 border border-gray-600 outline-none"
              placeholder="Add tag..."
              value={tagInput}
            ...
            <button onClick={addTag} className="text-xs bg-gray-700 text-gray-300 px-2 rounded-md hover:bg-gray-600">+</button>
          </div>
        </div>
        ...
        <div>
          ...
          <select
            ...
            className={`w-full bg-gray-800 text-xs rounded-md px-2 py-1.5 border border-gray-600 outline-none ${priorityColors[props.priority] || 'text-gray-200'}`}
          >
        ...
        <div>
          ...
          <select
            ...
            className={`w-full bg-gray-800 text-xs rounded-md px-2 py-1.5 border border-gray-600 outline-none ${statusColors[props.status] || 'text-gray-200'}`}
          >
            <option value="">None</option>
        ...
        {/* Comments */}
        <div>
          <label className="text-xs text-gray-400 block mb-2">Comments</label>
      ...
      <div className="p-3 border-t border-gray-700 flex gap-2">
        <input
          className="flex-1 bg-gray-800 text-white text-xs rounded-md px-2 py-1.5 border border-gray-600 outline-none"
